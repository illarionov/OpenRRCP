...
/*
  Internal register write bitmask
  Format of the table: <internal register>, <bitmask>,<R/W status>,<quantity of registers in a chain>
  Values of the R/W status: 0=Ro,1=RW,2=Wo
  Last value should be -1,0,0
*/

int registers_mask_unknown[]={
 -1,0,0
};

int registers_mask_rtl8326[]={
 -1,0,0
};

int registers_mask_rtl8316b[]={
  0x000,0x0003,2,1,
  0x001,0x009f,1,1,
  0x002,0x003f,0,1,
  0x004,0x0003,1,1,
